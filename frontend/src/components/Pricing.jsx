    ...
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div aria-hidden="true" className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl">
        <div
          ...
          className="mx-auto aspect-1155/678 w-full max-w-7xl bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-10"
        />
      </div>
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl">
        Boost your YouTube views with AI-powered title optimization. Choose the plan that fits your content creation needs.
      </p>
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative bg-indigo-50 shadow-lg' : 'bg-gray-50 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
          ...
          >
            <h3
              id={tier.id}
              className={classNames(tier.featured ? 'text-indigo-600' : 'text-indigo-600', 'text-base font-semibold')}
            >
              {tier.name}
            </h3>
            ...
            <p className={classNames(tier.featured ? 'text-gray-700' : 'text-gray-700', 'mt-6 text-base')}>
              {tier.description}
            </p>
            <ul
              role="list"
            ...
            >
              {tier.features.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <CheckIcon
                    aria-hidden="true"
                    className={classNames(tier.featured ? 'text-indigo-600' : 'text-indigo-600', 'h-6 w-5 flex-none')}
                  />
                  {feature}
                </li>
              ))}
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ...
                  : 'bg-gray-100 text-gray-900 border border-gray-300 hover:bg-gray-200 focus-visible:outline-gray-600',
