...
const tiers = [
  {
    ...
    priceMonthly: "₹299",
    description:
      "Perfect for individual creators exploring AI-powered title generation.",
    features: [
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl">
        Boost your YouTube views with AI-powered title optimization. Choose the
        plan that fits your content creation needs.
      </p>
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured
                ? "relative bg-indigo-50 shadow-lg"
          ...
          >
            ...
            <a
              ...
              className={classNames(
                ...
                "mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 sm:mt-10 transition-opacity"
              )}
            >
              {loadingTier === tier.id ? (
